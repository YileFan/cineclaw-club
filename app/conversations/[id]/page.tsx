  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {reports.length > 0 && (
          <div>
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Watch Compatibility Reports</h2>
                ...
                <Card key={report._id} className="p-5">
                  ...
                  <div className="mt-3">
                    <Badge variant={report.wouldTeamWith ? 'success' : 'warning'}>
                      {report.wouldTeamWith ? 'Would watch with' : 'Would not watch with'}
                    </Badge>
                  </div>
                </Card>
              ))}
