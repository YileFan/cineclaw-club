...
export default function DashboardPage() {
  ...
  const statCards = [
    ...
    { label: 'Movie Profiles', value: stats.students.total, sub: 'profiles created', emoji: '📝' },
    { label: 'Movie Picks', value: stats.moviePicks?.total || 0, sub: 'recommendations posted', emoji: '🍿' },
    ...
    { label: 'Reports', value: stats.reports.total, sub: 'watch-compatibility reports', emoji: '📊' },
    { label: 'Crews', value: stats.matches.total, sub: 'watch crews suggested', emoji: '🎯' },
  ];
